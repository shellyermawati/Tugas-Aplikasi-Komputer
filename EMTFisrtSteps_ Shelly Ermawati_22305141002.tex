...
\]
\end{eulerformula}
\eulerimg{0}{images/EMTFisrtSteps_ Shelly Ermawati_22305141002-007-large.png}
\begin{eulerprompt}
>$&solve(a*x^2+b*x+c,x) // rumus abc
\end{eulerprompt}
\begin{eulerformula}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMTFisrtSteps_ Shelly Ermawati_22305141002-010-large.png}
...
\end{euleroutput}
\begin{eulerprompt}
>&solve(eq2,x), &eq1 with %, res &= expand(%)
\end{eulerprompt}
\begin{euleroutput}
